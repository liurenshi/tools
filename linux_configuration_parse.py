...
def get_args():
    ...
    arg_parser.add_argument('-s', '--src', default='.config', help='linux kernel config file path, default: .config',
                            dest='src_path')
    arg_parser.add_argument('-d', '--dest', required=True, help='source insight conditional parsing xml file path',
                            dest='dest_path')
